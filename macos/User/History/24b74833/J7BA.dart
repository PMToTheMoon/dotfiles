...
class TitledSection extends WrappedFormSection {
  TitledSection({
    ...
    required super.fields,
          ...
          if (padding != null) {
            return _wrapWithPadding(section, padding);
          }
          return section;
        });
}
...
InvokeExpression _wrapWithPadding(Expression section, Expression padding) =>
    InvokeExpression.newOf(refer('Padding', 'package:flutter/material'), [], {
      'padding': padding,
      'child': section,
    });
