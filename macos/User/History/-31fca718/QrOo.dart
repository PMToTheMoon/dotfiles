...
class UserRepository {
  ...
  Future<void> newPassenger(
    ...
    var batch = List<Passenger>.from(favoritePassengers ?? []);
    batch.add(Passenger(
      id: 0,
    ...
    await _urbanDriver.passengerBatchReplace(
      PassengerBatchReplaceRequest.fromDomain(batch),
    );
    await fetch();
  }

  Future<String> newPaymentMethodUrl() => _urbanDriver.sessions();
