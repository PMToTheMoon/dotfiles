...
class Dependencies extends DelegatingList<Dependency> {
  static const empty = Dependencies([]);

  const Dependencies(super.base);
}
...
abstract class Dependency {
  ...
  Dependency.shared(
    String path, {
    this.fallback,
  })  : ipr = AssetId.ipr(path),
        output = AssetId.output(path);
