...
abstract class StateMachine<Event, State> extends Bloc<Event, State> {
  ...
  /// parameter that give the opportunity to register the [DefinedState]
  /// events handler and transitions thanks to a [StateDefinitionBuilder]
  /// passed as parameter
  ///  providing
  /// necessary methods to registers transitions and side effects is passed
  /// to the [definitionBuilder] as parameter. The [definitionBuilder] should
  /// call needed [StateDefinitionBuilder]'s object methods to describe
  /// the [DefinedState] and then return the [StateDefinitionBuilder].
  ///
  /// ```dart
