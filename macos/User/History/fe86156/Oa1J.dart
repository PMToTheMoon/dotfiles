...
abstract class StateMachine<Event, State> extends Bloc<Event, State> {
  ...
  ///
  /// The define method should be called once for each state machine
  /// allowed state **inside the class constructor**. Defined states should
  /// always be sub-classes of the base [State] class.
  ///
  ...
  /// events handler and transitions.
  ///
