...
enum BadgeColor {
  ...
  Color color(BuildContext context) {
    final colors = context.theme.extension<BadgeColors>();
    if (colors == null) return context.colorScheme.primary;
    switch (this) {
      case red:
        return colors.red;
      case green:
...
class BadgeColors extends ThemeExtension<BadgeColors> {
  ...
  const BadgeColors({
    ...
    Color? blueContainer,
        ...
        blueContainer = blueContainer ?? AppColors.blueSemiTransparent;
