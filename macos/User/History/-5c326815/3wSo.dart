...
import 'package:tech_by_tech/candidate/repositories/candidates_repository.dart';
...
class TechByTechApp extends StatelessWidget {
  ...
  final CandidateRepository candid
  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider(create: (context) => candidatesRepository),
      ],
      child: BlocProvider(
