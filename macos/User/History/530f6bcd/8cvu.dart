...
class AppServices {
  ...
  static DoctorService get user => GetIt.instance.get<DoctorService>();
  ...
  @Deprecated('Use GetIt.instance.get<AvatarCacheService>() instead.')
