...
void main() {
  group('Record from json (getDossier)', () {
    ...
    test('sample 4', () {
      Record? record;
      record =
          Record.fromJson(recordSample4['dossier'] as Map<String, dynamic>);
      expect(record, isNot(null));
    });
    test('sample 5', () {
      Record? record;
      record =
          Record.fromJson(recordSample5['dossier'] as Map<String, dynamic>);
      expect(record, isNot(null));
    });
    test('sample 6', () {
      Record? record;
      record =
          Record.fromJson(recordSample6['dossier'] as Map<String, dynamic>);
      expect(record, isNot(null));
    });
  });
}
