      ...
      ($checkedConvert) {
        ...
        final val = FetchBlocOptions(
          ...
          source: $checkedConvert(
              'source', (v) => FetchBlocSourceOptions.fromJson(v as Map)),
          data: $checkedConvert(
              'data', (v) => FetchBlocDataOptions.fromJson(v as Map)),
        );
        return val;
      },
    );

FetchBlocSourceOptions _$SourceFromJson(Map json) => $checkedCreate(
      'Source',
      json,
      ($checkedConvert) {
        $checkKeys(
        ...
        final val = FetchBlocSourceOptions(
...
FetchBlocDataOptions _$DataFromJson(Map json) => $checkedCreate(
      'Data',
      json,
      ($checkedConvert) {
        $checkKeys(
        ...
        final val = FetchBlocDataOptions(
          type: $checkedConvert('type', (v) => v as String),
        );
        return val;
      },
