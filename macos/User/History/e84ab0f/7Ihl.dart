...
abstract class BuildPhase {
  ...
  /// Whether input assets should be hidden from subsequent generators.
  bool get consumeInputs;

  /// Whether generated assets should be hidden to subsequent generators.
  bool get hideOutputs;
...
class InBuildPhase extends BuildPhase implements BuildAction {
  ...
  InBuildPhase(
    ...
    bool hideOutput = false,
            ...
            hideOutputs: hideOutput);

  @override
  String toString() {
    final settings = <String>[];
    if (isOptional) settings.add('optional');
    if (hideOutputs) settings.add('hidden');
    var result = '$generatorLabel on $generateFor in $package';
