...
class DoctorService {
  ...
  /// Return doctor's establishment list from cache or fetch it if not present
  ///
  /// You can force api fetch by setting [forceFetch] on true.
  Future<List<Establishment>> establishsments(
    String doctorId, {
