...
class _SwingState extends State<AlbumSwing>
  ...
  void initState() {
    ...
    animationRotation1 =
        Tween<double>(begin: widget.maxRotation, end: -widget.maxRotation)
    ...
    animationRotation3 = Tween<double>(begin: widget.maxRotation, end: 0)
        .animate(CurvedAnimation(
            parent: controller!,
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget? child) {
          double angle = (animationRotation1.value != -widget.maxRotation)
              ? animationRotation1.value
              : (animationRotation2.value != widget.maxRotation)
