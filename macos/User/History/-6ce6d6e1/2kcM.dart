...
class BuildImpl {
  ...
  Future<BuildResult> _runPhases({
    ...
    try {
      ...
      return BuildResult(
          BuildStatus.success, assetGraph.getAllGenerated().toList());
    } catch (e) {
      return BuildResult(
          BuildStatus.failure, assetGraph.getAllGenerated().toList());
    }
  }
  ...
  Future<void> _writeOutputs(
    ...
    final result = BuildResult(BuildStatus.success, assets);
      ...
      BuildDirectory('', outputLocation: OutputLocation(iprDir)),
      {
        BuildDirectory('',
            outputLocation: OutputLocation(
              _options.bonemealConfig.globalConfig.target ?? outputDir,
            ))
      },
    );
    return result;
