...
mixin _$PatientRecordsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<PatientRecord> records) ready,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(List<PatientRecord> records)? ready,
...
abstract class _$$PatientRecordsReadyCopyWith<$Res> {
  ...
  $Res call({List<PatientRecord> records});
}
...
class _$PatientRecordsReady extends PatientRecordsReady {
  const _$PatientRecordsReady({required final List<PatientRecord> records})
      : _records = records,
        super._();
...
abstract class PatientRecordsReady extends PatientRecordsState {
  const factory PatientRecordsReady(
      {required final List<PatientRecord> records}) = _$PatientRecordsReady;
  const PatientRecordsReady._() : super._();

  List<PatientRecord> get records => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  _$$PatientRecordsReadyCopyWith<_$PatientRecordsReady> get copyWith =>
      throw _privateConstructorUsedError;
}
