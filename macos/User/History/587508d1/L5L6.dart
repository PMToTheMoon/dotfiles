...
class AuthService implements AuthenticationProvider {
  ...
  Future<bool> validateOTP({
    ...
    if (session != null) {
      ...
      await storage.saveBearerToken(session.token);
  ...
  @override
  String? getBearerToken() => storage.getBearerToken();
  ...
  Future<void> refreshBearerToken() async {
    try {
      ...
      await storage.saveBearerToken(freshToken);
  ...
  Future<void> _updateCredentials({
    ...
    await storage.saveBearerToken(refreshToken);
