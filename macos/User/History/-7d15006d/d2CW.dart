...
class BuildStep<Data> extends PathProvidingAssetReader implements AssetWriter {
  BuildStep(
    this._reader,
    this._writer, {
    required this.input,
  ...
  Output build<Output>(MetaObject<Data, Output> object, Data input) {
...
abstract class MetaObject<Data, BuildMetaData> {
  ...
  FutureOr<BuildMetaData> build(BuildStep<Data, BuildMetaData> context);
}
