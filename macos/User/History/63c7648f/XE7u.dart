...
// This bloc provides candidate profile information
//
// Since theses data will change over time (user can edit data), this bloc
// subscribes to a [candidateStream] to be notified of any change
class CandidateProfileBloc
    extends Bloc<CandidateProfileEvent, CandidateProfileState> {
  CandidateProfileBloc({
    required Candidate initialCandidate,
    required Stream<Candidate> candidateStream,
  ...
  final CandidateRepository userRepository;
