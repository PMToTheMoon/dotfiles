...
class BuildStepImpl implements BuildStep {
  ...
  final MemoryFileSystem _writeFileSystem = MemoryFileSystem();

  BuildStepImpl({
    AssetReader reader,
  })  : _writeFileSystem = MemoryFileSystem(),
        ipr = BuildStepIPR(reader, writer),
        output =
            BuildStepOutputImpl(reader, InMemoryAssetWriter(_writeFileSystem));
}
