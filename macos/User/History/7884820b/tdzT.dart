...
import 'package:bonemeal_core/src/generate/options.dart'
    show defaultNonRootVisibleAssets;
import 'package_graph.dart';
import 'input_matcher.dart';

final _log = Logger('TargetGraph');
...
class TargetGraph {
  ...
  /// The [BonemealConfig] of the root package.
  final BonemealConfig rootPackageConfig;
  ...
  static Future<TargetGraph> forPackageGraph(PackageGraph packageGraph,
    ...
    late BonemealConfig rootPackageConfig;
  ...
  /// asset public by including it in [BonemealConfig.additionalPublicAssets].
  ///
