...
Je ne peux pas vous proposer de définitif à l'heure actuelle, le cahier des charges n'étant pas assez précis pour cela.

Je vous propose de travailler de la facon suivante:
...
En phase de développment, je vous donnes accès à la version "dev" de l'application pour que vous puissiez la testée. Je produit un nouveau build toutes les 1 à 2 semaines que je vous envoie accompagné de la liste des changements. De cette facon, vous pouvez suivre l'avancement du projet et me faire vos retours si quelque chose ne vous convient pas.
