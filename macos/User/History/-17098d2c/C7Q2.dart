...
class HomeRecords extends StatelessWidget {
  ...
  void _onError(BuildContext context, HomeRecordsState? state) {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocListener<HomeRecordsBloc, HomeRecordsState?>(
                ...
                children: [
                  HomeRecordsList(
                    ...
                    dataFactory: (e) => e.toRecordCardWithStatusData(
                      context,
                      userId: userId ?? 'null',
                      avatarCacheService: GetIt.I.get(),
                    ),
                  ),
                  HomeRecordsList(
                  ...
                  HomeRecordsList(
                    ...
                    onSelected: (record) => _onSelectRecord(context, record),
                    dataFactory: (record) =>
                        record.toRecordCardWithEditButtonData(
                      context,
                      userId: userId ?? 'null',
                      avatarCacheService: GetIt.I.get(),
