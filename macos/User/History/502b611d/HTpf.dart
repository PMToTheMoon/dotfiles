...
class CandidateRepository {
  ...
  Future<void> createProfessionalExperience(
    ...
    await _candidateApi.createProfessionalExperience(
        authRepository.session.userId, experience);
    await fetchProfessionalExperiences();
  }
  ...
  Future<void> updateProfessionalExperience(
    ...
    await _candidateApi.updateProfessionalExperience(authRepository.session.userId , experienceId, update)
    if (_professionalExperiences != null) {
      final experiences =
          List<ProfessionalExperience>.from(_professionalExperiences!);
      final experienceIndex =
          experiences.indexWhere((element) => element.id == update.id);
      final e = experiences[experienceIndex];
      experiences[experienceIndex] = ProfessionalExperience(
        id: e.id,
