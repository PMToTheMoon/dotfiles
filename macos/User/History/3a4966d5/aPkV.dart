...
import 'package:app_client/trip_details/contact/view/contact.dart';
...
class _TripDetailsPage extends StatelessWidget {
  ...
  void _onBookReturnTrip(BuildContext context, Trip trip) async {
    ...
    String? flightNumber;
    int? departureDelay;
    Address _departure = trip.arrival;
    ...
    if (_departure.type == AddressType.train) {
      ...
      final result = await FlightNumberSelectionPage.open(
        context,
        const FlightNumberSelectionPageArguments(date: null),
      );
      date = result?.date;
            ...
            child: Column(
              ...
              children: [
                ...
                Button.menu(
                  ...
                  () => ContactPage.open(context, ContactPageArguments()),
                  color: context.colorScheme.onSurface,
                ),
                if (trip.transactionID != null)
                  Padding(
