...
## Records
Le service `PatientService` et tous les blocs associées sont utilisées dans l'onglet détails patient, groupés dans la feature [patient](/Users/pm/Project/zanalys/zanalys-app-flutter/lib/patient)