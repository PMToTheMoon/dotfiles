...
import 'form/chip_editor_form_field.dart';
import 'form/column_section.dart';
import 'form/multi_line_form_field.dart';
import 'form/titled_section.dart';

extension ToL10nCall on String {
  String get tr => 'context.l10n.$this';
}

const requiredValidator =
    'FormBuilderValidators.required(errorText: context.l10n.required_error)';

const hiddenReasonValidator = '''
(value) {
