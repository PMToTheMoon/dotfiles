...
class ReservationBloc extends Bloc<ReservationEvent, ReservationState> {
  ...
  void _onAddressesSelected(
    ...
    ReservationState newState = state;
    if (result.departureChanged) {
      newState = newState.copyWith(
        trainNumber: event.value.departureTrainNumber,
      flightNumber: event.value.departureFlightNumber,
      departureDelay: event.value.departureDelay,
      date: event.value.departureDate ?? state.date,
      )
    }
    ...
    emit(state.copyWith(
      status: ReservationStateStatus.editing,
      departure: event.value.departureAddress,
      arrival: event.value.arrivalAddress,
