...
class CodeState with _$CodeState {
  ...
  const factory CodeState.signInSuccess() = CodeSignInSuccess;

  const factory CodeState.logInError() = CodeLogInError;
  const factory CodeState.logInSuccess() = CodeLogInSuccess;
}
