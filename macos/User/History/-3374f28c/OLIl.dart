...
import 'package:zanalys/record/hub/observations/new_complement_card/new_complement_form.dart';
import 'package:zanalys/record/hub/observations/new_general_rapport_card/new_general_rapport_form.dart';
...
class _ObservationsViewState extends State<_ObservationsView>
  ...
  Widget _buildRapportFormCard() {
    void onSubmitted(NewGeneralRapportFormSnapshot snapshot) {
      final noConsultation =
          snapshot.consultation.contains('Pas de rendez vous supplémentaire');
      ...
      final rapport = RapportGeneral(
        ...
        interpretation: snapshot.hiddenReason,
      );
      context
