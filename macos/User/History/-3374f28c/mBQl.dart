...
class _ObservationsViewState extends State<_ObservationsView>
  ...
  Widget _buildRequestCard() {
    return Padding(
      ...
      child: RequestCard(
        from: widget.hubState.effectiveRecord.doctorFirstName ?? 'unknown',
  ...
  Widget build(BuildContext context) {
    ...
    final showRapportForm = widget.hubState.serviceRequest != null &&
        widget.hubState.effectiveRecord.type == RecordType.general;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ObservationCard(
                  widget.hubState.effectiveRecord.toInitialObservationCardData(
