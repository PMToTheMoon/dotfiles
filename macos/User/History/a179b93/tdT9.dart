...
class BuildCacheReader implements PathProvidingAssetReader {
  ...
  String pathTo(AssetId id) {
    return _cacheLocation(id, _assetGraph).path;
  }

  @override
  String packagePathTo(AssetId id) => _cacheLocation(id, _assetGraph).path;
}
...
class _PathProvidingBuildCacheReader extends BuildCacheReader
  ...
  String packagePathTo(AssetId id) =>
      _delegate.packagePathTo(_cacheLocation(id, _assetGraph));
}
