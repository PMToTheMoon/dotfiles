...
import 'package:zanalys/hub/hub_page.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  Future _onStateChanged(BuildContext ctx, SignInState state) async {
    if (state.status.isSubmissionInProgress) {
      ...
      // TODO:
      // Copied from release/1.0.0, I don't know what is used for,
      // this should be investigated.
      //
      // Used to potentially update last user id and save user id checkbox
      setState(() {});
    }
  }
