...
sportive'''),
          ...
          const ObservationCardDataPart.symptoms(items: {
            'Mal de tête',
            'Très bon en programation',
          }),
...
rythmologique si besoin'''),
          const ObservationCardDataPart.rapport(
              observation: '''En l’absence de symptôme et devant l’absence
de trouble de conduction paroxystique ou de
pause diurne au holter, il faut poursuivre la
surveillance clinique et refaire un holter tous les 6
mois avant d’envisager une prise en charge
rythmologique si besoin'''),
          const ObservationCardDataPart.appointment(type: ServiceType.inPerson),
        ],
      ),
    );
