...
abstract class TbtAppColors {
  ...
  static final splash = Colors.white.withOpacity(.47);
  ...
  static final highlight = Colors.white.withOpacity(.47);
  static const outline = label;
  static const border = disabled;
