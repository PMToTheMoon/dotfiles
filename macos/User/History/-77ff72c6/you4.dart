...
class _ForgotPasswordLink extends StatelessWidget {
  ...
  _onForgotPasswordStateChanged(context, state) async {
    if (state is ForgotPasswordSuccess) {
      await showSuccessDialog(
        context,
        message: "Un email de réinitialization à bien été envoyé à l'address",
      );
    } else if (state is ForgotPasswordError) {
      showError(context, message: context.l10n.unexpected_error_message);
    }
  }
