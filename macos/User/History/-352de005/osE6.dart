...
class _NewPassengerPageState extends State<_NewPassengerPage> {
  ...
  final _NewPassengerFormController controller = _NewPassengerFormController();
  ...
  Widget build(BuildContext context) {
    return Form(
      ...
      child: Column(
        ...
        children: [
          TextFormField(
            decoration: InputDecoration(hintText: context.l10n.first_name_hint),
          ...
          TextFormField(
            decoration: InputDecoration(hintText: context.l10n.last_name_hint),
            textInputAction: TextInputAction.next,
