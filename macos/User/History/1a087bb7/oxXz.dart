        ...
        children: [
          ...
          IntlPhoneField(
            ...
            validator: FormBuilderValidators.compose([
              ...
              (phoneNumber) {
                if (phoneNumber?.countryISOCode == "FR") {
                  if (phoneNumber?.number.startsWith(RegExp(r"6|7")) == true) {
                    return null;
                  }
                  return context.l10n.phone_should_be_mobile_number_error;
                }
                return null;
              }
            ]),
          ...
          CheckboxListTileFormField(
            ...
            title: Row(
              children: [
                Expanded(child: Text(context.l10n.accept_terms_of_use)),
                Button.text(
