...
class DateEditingController extends GuideEditingController {
  ...
  DateEditingController.yM({String? text, DateTime? date})
      : format = DateFormat.yM(),
        super(
          guide: 'MM/AAAA',
          text: date != null ? DateFormat.yM().format(date) : text,
        );

  final DateFormat format;

  DatePickerEditingValue get editingValue => DatePickerEditingValue(
        text: text,
        date: date,
      );
...
class DatePickerField extends StatefulWidget {
  ...
  final DatePickerEditingValue? initialDate;
          ...
          onPressed: widget.enabled == true
              ? () async {
                  ...
                  if (date != null && date != _controller.date) {
                    ...
                    widget.onChanged?.call(_controller.editingValue);
                  }
                }
              : null,
        ),
