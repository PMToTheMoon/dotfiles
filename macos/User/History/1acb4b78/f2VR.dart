...
import 'new_complement_form_snapshot.dart';

export 'new_complement_form_snapshot.dart';

part 'new_complement_form_controller.dart';

class NewComplementForm extends StatefulWidget {
  const NewComplementForm({
    this.onWillPop,
    this.onChanged,
  ...
  final NewComplementFormController? controller;

  @override
  NewComplementFormState createState() => NewComplementFormState();
}

class NewComplementFormState extends State<NewComplementForm> {
  NewComplementFormState();

  late final _controller = widget.controller ?? NewComplementFormController();
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SpaceSmall.h(),
                context.bodyMedium(context.l10n.obs_form_new_consultation_label)
              ],
            ),
          ),
          const SpaceSmall.h(),
