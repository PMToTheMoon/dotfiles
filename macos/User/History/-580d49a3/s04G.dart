...
mixin RecordApiClient {
  ...
  Future<void> addRapportToGeneralRecord(
    ...
    final test2 = recordStatus == RecordStatus.waitingRapport;
    final test3 = recordStatus.index == RecordStatus.waitingRapport.index;
    final test =
        recordStatus == RecordStatus.waitingRapport && completeRecord == true;
    if (completeRecord == false ||
        (recordStatus == RecordStatus.waitingRapport &&
            completeRecord == true)) {
      print("nul");
