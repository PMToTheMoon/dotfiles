...
mixin RecordApiClient {
  ...
  Future<void> addRapportToGeneralRecord(
    ...
    } else if (recordStatus == RecordStatus.waitingReport) {
      serviceType = ServiceType.teleExpertise;
    }
    ...
    final rapportJson = jsonEncode({
      "rapport": {
        "identifiant": 0,
        "referenceDossier": "DM563853356860",
      ...
      "completedRapport": true,
      "capturePayment": true,
      "typeDossier": "MULTI",
      "referenceDossier": "DM563853356860",
      "typePrestation": "TELEEXPERTISE",
