...
Iterable<DoctorWithEstablishments> _associateDoctorsWithEstablishments(Iterable<Doctor> doctor) {
  Set<Doctor?> doctors = {};
  doctors.addAll([
    _doctor(record),
    _delegate(record),
...
DoctorWithEstablishments _associateDoctorWithEstablishments(Doctor doctor) {
  final establishments = await doc
  return doctors.whereType<Doctor>();
}
