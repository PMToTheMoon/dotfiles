...
Iterable<DoctorWithEstablishments> _associateDoctorsWithEstablishments(Iterable<Doctor> doctor) async {
  Set<Doctor?> doctors = {};
  doctors.addAll([
    _doctor(record),
    _delegate(record),
...
Future<DoctorWithEstablishments> _associateDoctorWithEstablishments(Doctor doctor) async {
  final establishments = await doctorService.
  return doctors.whereType<Doctor>();
}
