...
final lightTheme = ThemeData(
  ...
  hoverColor: TbtAppColors.blueHover.withOpacity(.22),
  focusColor: TbtAppColors.blueHover.withOpacity(.22),
  splashColor: TbtAppColors.highlight,
  // highlightColor: TbtAppColors.highlight,
