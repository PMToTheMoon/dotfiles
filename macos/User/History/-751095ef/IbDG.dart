...
PreferredSizeWidget titleSubtitleAvatarAppBar(
  BuildContext context, {
  required String title,
  required String subtitle,
...
class _HeroAppBar extends StatelessWidget implements PreferredSizeWidget {
  const _HeroAppBar(this.appBar);

  final AppBar appBar;

  @override
  Widget build(BuildContext context) {
    return Hero(tag: 'app_bar', child: appBar);
  }
