...
class UIKitPage extends StatelessWidget {
  ...
  _buildIdentities(BuildContext context) => [
    Identity(avatar: AssetImage(Assets.images.launcherIcon.keyName), firstName: 'Pierre'),
    Identity(avatar: AssetImage(Assets.images.launcherIcon.keyName), firstName: 'Pierre', lastName: 'Martin',),
  ]
}
