...
class UIKitPage extends StatelessWidget {
  ...
  _buildStatus(BuildContext context) => const [
        StatusBar(priority: Priority.hight, value: 0),
        SpaceSmall(),
        StatusBar(priority: Priority.medium, value: 0.3),
        SpaceSmall(),
        StatusBar(priority: Priority.low, value: 0.7),
        SpaceSmall(),
        StatusBar(priority: Priority.low, value: 1),
        StatusBadge(priority: Priority.hight),
        SpaceSmall(),
        StatusBadge(priority: Priority.medium),
        SpaceSmall(),
        StatusBadge(priority: Priority.low),
        SpaceSmall(),
        StatusBadge(priority: Priority.low),
        SpaceSmall(),
      ];
