...
class UIKitPage extends StatelessWidget {
  ...
  _buildStatus(BuildContext context) => [
        const StatusBar(priority: Status.hight, value: 0),
        const SpaceSmall(),
        const StatusBar(priority: Status.hight, value: 0.3),
        const SpaceSmall(),
        const StatusBar(priority: Status.medium, value: 0.5),
        const SpaceSmall(),
        const StatusBar(priority: Status.low, value: 0.7),
        const SpaceSmall(),
        const StatusBar(priority: Status.done, value: 1),
        const SpaceSmall(),
        Row(
          children: const [
