...
class UIKitPage extends StatelessWidget {
  ...
  _buildStatus(BuildContext context) => [
        const StatusBar(priority: Priority.hight, value: 0),
        const SpaceSmall(),
        const StatusBar(priority: Priority.medium, value: 0.3),
        const SpaceSmall(),
        const StatusBar(priority: Priority.low, value: 0.7),
        const SpaceSmall(),
        const StatusBar(priority: Priority.low, value: 1),
        const SpaceSmall(),
        Row(
          children: const [
