...
abstract class Generator {
  ...
  ///   extensions based on [GeneratorOption].
...
class GeneratorOption {
  ...
  static const empty = GeneratorOption({});

  /// A configuration with [isRoot] set to `true`, and no options set.
  static const forRoot = GeneratorOption({}, isRoot: true);
  ...
  const GeneratorOption(this.config, {this.isRoot = false});
  ...
  GeneratorOption overrideWith(GeneratorOption? other) {
...
typedef BuilderFactory = Generator Function(GeneratorOption options);
