...
class BonemealConfig {
  ...
  factory BonemealConfig.parse(
    ...
    try {
      return checkedYamlDecode(
        configYaml,
        (map) => BonemealConfig.fromMap(
            packageName, dependencies, map ?? const <String, dynamic>{}),
        allowNull: true,
  ...
  factory BonemealConfig.fromMap(String packageName,
      Iterable<String> dependencies, Map<String, dynamic> config) {
  ...
  factory BonemealConfig._fromJson(Map<String, dynamic> json) =>
...
class GlobalBonemealConfig {
  ...
  factory GlobalBonemealConfig.fromJson(Map<String, dynamic> json) =>
