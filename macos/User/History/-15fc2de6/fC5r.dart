      ...
      child: Column(
        ...
        children: [
          ...
          DatePickerButton(
            ...
            onDateChanged: (selected) => context
                .read<ReservationBloc>()
                .add(ReservationEvent.dateSelected(selected)),
          ),
          if (state.dateWithDepartureDelay?.isBefore(DateTime.now()) == true)
            Padding(
              padding: const Padding5(left | top),
              child: context.bodyText1(
                context.l10n.departure_date_in_past_error(
                    DateTime.now().fullDateTimeDisplay(context)),
