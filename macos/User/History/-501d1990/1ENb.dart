...
abstract class Validators {
  ...
  static Validator<String> dateFormat(
  ...
  static Validator<DateTime?> datePickerTextFormat(
    BuildContext context,
    DateEditingController controller,
  ) =>
      (_) {
        try {
          controller.format.parseStrict(controller.text);
          return null;
        } catch (e) {
          return context.l10n.invalid_date_format('MM/YYYY');
        }
      };
  ...
  static Validator<String> minLength(
    ...
    int minLength,
      ...
      FormBuilderValidators.minLength(minLength,
          errorText: context.l10n.form_error_min_length(minLength));

  static Validator<String> maxLength(
    BuildContext context,
    int maxLength,
  ) =>
      FormBuilderValidators.minLength(maxLength,
          errorText: context.l10n.form_error_max_length(maxLength));
}
