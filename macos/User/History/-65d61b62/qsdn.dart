...
abstract class AnimatedListDiff<T> extends StatefulWidget {
  const AnimatedListDiff({required this.items, super.key});
  final List<T> items;
}

mixin AnimatedListDiffState<T, U extends AnimatedListDiff> on State<U> {
...
class CandidateEducationsListView extends AnimatedListDiff<Education> {
