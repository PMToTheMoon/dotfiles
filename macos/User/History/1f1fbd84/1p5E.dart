...
final consultationBillFields ={
  ...
  jsonField('preAuthorizationTotalExclTaxes', refer('double'), name:'preautorisationTotalHT'),
  jsonField('preAuthTotalInclTaxes', refer('double'), name:'preautorisationTotalTTC'),
