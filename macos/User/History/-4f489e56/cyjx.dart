...
MedicalContext _medicalContextFromSnapshot(
  ...
  return MedicalContext(
    id: 0,
    epworth: snapshot.epworth,
    medicalHistory: snapshot.medicalHistory,
    definedMedicalHistory: snapshot.definedMedicalHistory,
    medicalHistoryText: snapshot.medicalHistoryText,
    cvRisks: snapshot.cvRisks,
    cvRisksSet: snapshot.cvRisksSet,
    symptoms: snapshot.symptoms,
    definedSymptomes: snapshot.definedSymptomes,
    symptomsText: snapshot.symptomsText,
    pain: snapshot.pain,
    definedPain: snapshot.definedPain,
  );
}
