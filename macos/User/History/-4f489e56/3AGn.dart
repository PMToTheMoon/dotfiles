...
import 'widgets/general_initial_observation_form_snapshot.dart';
    ...
    return OverlayLoadingIndicator(
      ...
      child: Scaffold(
        ...
        appBar: titleSubtitleAvatarAppBar(
          ...
          image: avatarCacheService.avatar(widget.record.patient.id),
        ),
        body: Padding(
...
MedicalContext _medicalContextFromSnapshot(
  ...
  return MedicalContext(
    ...
    cvRisks: false,
    cvRisksSet: null,
    symptoms: null, //snapshot.symptoms.toList(),
    definedSymptomes: null, //snapshot.symptoms.isNotEmpty,
