...
import 'package:tech_by_tech/candidate/profile/professional_experiences/candidate_professional_experiences.dart';
...
RouteBase candidateRouteTree(BuildContext context) => ShellRoute(
      ...
      routes: [
        ...
        ShellRoute(
          path: 'profile',
          defaultRoute: 'professional-experiences',
          ...
          routes: [
            ...
            StackedRoute(
              ...
              builder: CandidateProfessionalExperiences.builder,
            ),
          ],
        ),
      ],
