...
class _ContextualMenuButton {
  const _ContextualMenuButton({
    this.onPressed,
    required this.child,
  });
...
class TbtIconMenu extends StatelessWidget {
  ...
  final IconData icon;
  final List<_ContextualMenuButton> children;
  final double spacing;
  final EdgeInsetsGeometry padding;
  final BorderRadius borderRadius;

  Widget _buildMenuButton(_ContextualMenuButton item, hideMenu) {
