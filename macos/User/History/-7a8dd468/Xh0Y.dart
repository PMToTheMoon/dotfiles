    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          space,
          _TextField(value: patient.birthDate, label: "Prénom de naissance"),
          space,
          ...
          space,
          _TextField(value: patient.birthDate, label: "Prénom d'usage"),
          space,
          _TextField(value: patient.birthDate, label: "Nom d'usage"),
          space,
        ],
      ),
    );
