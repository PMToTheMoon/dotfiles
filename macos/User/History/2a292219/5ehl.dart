...
class AddressSelectionBloc
  ...
  AddressSelectionBloc({
    ...
    int? initialDepartureDelay,
          ...
          AddressSelectionState(
            ...
            departureDelay: initialDepartureDelay,
          ),
        ) {
    ...
    on<AddressSelectionDepartureAddressSelected>(_onDepartureAddressSelected);
    on<AddressSelectionArrivalAddressSelected>(_onArrivalAddressSelected);
  ...
  void _onDepartureAddressSelected(
    AddressSelectionDepartureAddressSelected event,
    Emitter<AddressSelectionState> emit,
  ) async {
    emit(state.copyWith(
      ...
      departureDelay: event.departureDelay,
      date: event.date,
    ));
  }

  void _onArrivalAddressSelected(
    AddressSelectionArrivalAddressSelected event,
    Emitter<AddressSelectionState> emit,
  ) async {
    emit(state.copyWith(
      filter: AddressType.location,
