    ...
    define<ParentStateA>(
      ($) => $
        ...
        ..define<AChildState1>(($) => $
          ...
          ..on<TriggerNestedStateOnExit>((e, s) => AChildState2())
...
void main(List<String> args) {
  group("nested state lifecycle test", () {
    ...
    test("nested state onChange called when transiting to same sub state", () async {
    ...
    test("parent's onEnter called when transiting to one of its sub states", () async {
      final sm = DummyStateMachine();
    ...
    test("parent's onChange called when transiting to another of its sub states", () async {
                  final sm = DummyStateMachine();
    ...
    test("parent's onExit called when transiting to a state that is not one of its child", () async {
      final sm = DummyStateMachine();
