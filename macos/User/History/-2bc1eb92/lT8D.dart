...
part 'new_general_rapport_form_snapshot.dart';
        ...
        children: [
                  ...
                  child: Column(children: [
                    MultiLineTextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (_controller.rapport.text.isNotEmpty == true) {
                            return null;
                          }
          ...
          Padding(
              ...
              child: TitledSection(
                  ...
                  child: Column(children: [
                    MultiLineTextFormField(
                        controller: _controller.rapport,
                        textInputAction: TextInputAction.next,
                        hint: context.l10n.obs_rapport_hint,
                        border: false,
                        validator: (value) {
                          if (value?.isNotEmpty == true) return null;
