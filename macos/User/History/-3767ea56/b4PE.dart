...
final providerConsultationFields = {
  ...
  jsonField('consultationType', refer('ConsultationType'),
      name: 'consultationType'),
  jsonField('color', refer('String'), name: 'couleur'),
  jsonField('date', refer('DateTime'), name: 'dateRdv'),
  jsonField('dateRdvMoment', refer('DateTime'), name: 'moment'),
  ...
  jsonField('recordReason', refer('RecordReason'), name: 'dossierMotif'),
  jsonField('recordStatus', refer('RecordStatus'), name: 'dossierStatut'),
  jsonField('recordCreationDate', refer('DateTime'),
      name: 'dossierDateCreation'),
  jsonField('recordServiceType', refer('ServiceType'),
      name: 'dossierTypePrestation'),
  jsonField('cpsUserLastName', refer('String'), name: 'cpsNom'),
  jsonField('cpsUserFirstName', refer('String'), name: 'cpsPrenom'),
};
