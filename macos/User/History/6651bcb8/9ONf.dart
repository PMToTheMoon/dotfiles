...
enum ProfileTabs {
  ...
  String display(BuildContext context) {
    switch (this) {
      ...
      case ProfileTabs.background:
        return context.l10n.candidate_profile_tab_background;
      case ProfileTabs.skills:
        return context.l10n.candidate_profile_tab_skills;
    }
  }
  ...
  void navigate(BuildContext context) {
    switch (this) {
      ...
      case ProfileTabs.background:
        return RouteState.of(context).goTo('/profile/background');
      case ProfileTabs.skills:
        return RouteState.of(context).goTo('/profile/skills');
    }
  }
...
int _initialTabIndex(BuildContext context) {
  ...
  if (match != null) {
    ...
    if (match.getLast()?.path == 'background') return 2;
    if (match.getLast()?.path == 'skills') return 3;
  }
  return 0;
}
          ...
          TabCard(
            ...
            child: Padding(
              padding: const EdgeInsets.symmetric(
                ...
                horizontal: Dimensions.paddingLargest,
              ),
              child: widget.body,
            ),
          ),
