...
part 'widgets/medical_information.dart';
part 'widgets/close.dart';
            ...
            children: [
              ...
              Flexible(
                child: Align(
                  ...
                  child: ColoredChip.red(data.doctor.specialty),
                ),
              )
            ],
          ),
...
Widget _buildPart(ObservationCardDataPart part) => part.map(
      ...
      medicalInformation: _MedicalInformation.new,
