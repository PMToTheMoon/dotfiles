...
class _ContactPage extends StatelessWidget {
  ...
  _onStateChanged(BuildContext context, ContactState state) async {
    ...
    if (state is ContactStateSuccess) {
      await showSuccessDialog(context,
          message: context.l10n.contact_page_successfully_sent_message);
      ...
      child: Page(
        ...
        body: Column(
          ...
          children: [
            ...
            const Space3.h(),
            context.subtitle2(
              context.l10n.contact_page_subtitle(trip.id.toString()),
            ),
