...
mixin _$PatientListState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String filter, List<Patienteu> patients) ready,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(String filter, List<Patienteu> patients)? ready,
...
abstract class _$$PatientListReadyCopyWith<$Res>
  ...
  @override
  $Res call({String filter, List<Patienteu> patients});
}
...
class _$PatientListReady extends PatientListReady {
  const _$PatientListReady(
      {required this.filter, required final List<Patienteu> patients})
      : _patients = patients,
        super._();

  @override
  final String filter;
  final List<Patienteu> _patients;
  @override
  List<Patienteu> get patients {
...
abstract class PatientListReady extends PatientListState {
  const factory PatientListReady(
      {required final String filter,
      required final List<Patienteu> patients}) = _$PatientListReady;
  const PatientListReady._() : super._();

  @override
  String get filter => throw _privateConstructorUsedError;
  List<Patienteu> get patients => throw _privateConstructorUsedError;
  @override
  @JsonKey(ignore: true)
  _$$PatientListReadyCopyWith<_$PatientListReady> get copyWith =>
      throw _privateConstructorUsedError;
