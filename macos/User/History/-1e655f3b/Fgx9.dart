...
class DoctorListBloc extends Bloc<DoctorListEvent, DoctorListState> {
  ...
  Future<void> _onDoctorSelected(
    ...
    final selectedDoctors = Set.of(state.selectedDoctors)..add(event.doctor);
  ...
  Future<void> _onDoctorUnselected(
    ...
    final selectedDoctors = Set.of(state.selectedDoctors)..remove(event.doctor);
  ...
  List<Doctor> _transformDoctors(
    ...
    int compareDoctor(Doctor a, Doctor b) {
      final aIsSelected = selectedDoctors.contains(a);
      final bIsSelected = selectedDoctors.contains(a);
