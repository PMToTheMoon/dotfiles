...
class TripleStateBloc extends Bloc {
  factory TripleStateBloc({
    ...
    Field? data;
    final sourceReturnsSymbol = source.fetch.returns?.symbol;
    if (sourceReturnsSymbol != null &&
        sourceReturnsSymbol != 'Future<void>' &&
        sourceReturnsSymbol != 'Future' &&
        sourceReturnsSymbol != 'void') {}
