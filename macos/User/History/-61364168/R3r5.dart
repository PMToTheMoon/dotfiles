...
import 'edit_record_medical_information_multi.dart';
...
final newMultiRecord = JsonSerializable('NewRecordMulti', {
  ...
  nestedJsonField(
    ...
    refer(
      ...
      'medical_information/new_record_medical_information_multi.dart',
    ),
...
final newRecordModels = Root('record_api/models/', [
  Root('medical_information/', [
    editRecordMedicalInformationMulti,
  ]),
  newMultiRecord,
]);
