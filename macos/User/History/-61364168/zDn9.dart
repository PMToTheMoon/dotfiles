...
import 'new_record_medical_information_multi.dart';

final newRecordFieldsBase = <Field>{
  jsonField(
    'id',
    refer('String'),
    name: 'reference',
...
final newMultiRecord = JsonSerializable('NewRecordMulti', {
  ...newRecordFieldsBase,
  nestedJsonField(
    'medicalInformationMulti',
    refer(
      'NewRecordMedicalInformationMulti',
      'medical_information/medical_information_multi.dart',
    ),
...
final newRecordModels = Root(
    'packages/zanalys_api/lib/src/record_api/models/full_record_response.dart',
    [
      newRecordMedicalInformationMulti,
      newMultiRecord,
    ]);
