...
enum AssetType {
  ...
  const AssetType(this._id);
  final int _id;

  int compareTo(AssetType other) => _id - other._id;
}

/// Identifies an asset within a package.
class AssetId implements Comparable<AssetId> {
  /// The type of asset.
  final AssetType package;
  ...
  factory AssetId.resolve(Uri uri, {AssetId? from}) {
    ...
    if (resolved.scheme == 'package') {
      ...
      return AssetId.source(p.url.joinAll(resolved.pathSegments.skip(1)));
    }
