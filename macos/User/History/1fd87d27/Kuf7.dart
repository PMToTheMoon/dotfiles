...
class Form extends MetaObject<FormMetaData> {
  ...
  Future<FormMetaData> build(BuildStep step) async {
    ...
    await _buildWidget(step, sectionsMetaData, snapshot.asDependencies);
