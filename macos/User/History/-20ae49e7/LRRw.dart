...
class LoadedList extends StatelessWidget {
  const LoadedList({
    super.key,
    this.loadingIndicator = const ButtonLoadingIndicator(),
    this.header,
    this.footer,
    this.spacing,
    this.separator,
    this.emptyIndicator = const EmptyListIndicator(),
    this.children,
    this.itemPadding,
    this.headerPadding,
    this.footerPadding,
    ...
    this.placeLoadingIndicatorInsideList = true,
    this.placeEmptyIndicatorInsideList = true,
  });
  ...
  final bool placeLoadingIndicatorInsideList;

  /// if true, place indicators inside list as normal child
  final bool placeEmptyIndicatorInsideList;
  ...
  Widget build(BuildContext context) {
    ...
    if (_showEmptyIndicator && placeEmptyIndicatorInsideList == false) {
      return effectiveEmptyIndicator!;
    }
    final effectiveLoadingIndicator =
        _maybeWrapIndicatorWithPadding(loadingIndicator);

    if (_showLoadingIndicator && placeLoadingIndicatorInsideList == false) {
