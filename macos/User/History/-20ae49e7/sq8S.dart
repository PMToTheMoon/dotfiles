...
class LoadedList extends StatelessWidget {
  ...
  final bool placeLoadingIndicatorsInsideList;

  /// if true, place indicators inside list as normal child
  final bool placeEmptyIndicatorsInsideList;
  ...
  Widget build(BuildContext context) {
    ...
    if (placeEmptyIndicatorsInsideList == false && _showEmptyIndicator) {
      return effectiveEmptyIndicator!;
    }
    if (placeLoadingIndicatorsInsideList == false && _showLoadingIndicator) {
      return effectiveEmptyIndicator!;
    }
