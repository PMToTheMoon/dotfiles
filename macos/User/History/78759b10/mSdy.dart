...
typedef PatientSelectedCallback = void Function(Patient);

class PatientListPage extends StatelessWidget {
  static PatientListPage builder(
    BuildContext context, {
    PatientSelectedCallback? onPatientSelected,
  }) =>
      PatientListPage(
  ...
  static MaterialPageRoute materialPageRoute({
    PatientSelectedCallback? onPatientSelected,
      ...
      MaterialPageRoute(
        builder: (context) =>
            builder(context, onPatientSelected: onPatientSelected),
      );
  ...
  final PatientSelectedCallback? onPatientSelected;
