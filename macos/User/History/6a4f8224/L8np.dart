...
class StreamViewBloc extends YamlMetaObject<StreamViewBlocInput> {
  @override
  final key = 'stream_view_bloc';

  @override
  StreamViewBlocInput dataFactory(Map input) =>
      StreamViewBlocInput.fromJson(input);

  @override
  FutureOr<void> build(BuildStep context, StreamViewBlocInput data) async {
