  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<NewPaymentMethodBloc, NewPaymentMethodState>(
        ...
        builder: (ctx, state) => 
        state is NewPaymentMethodDisplayingUrl ?
        WebViewPage(
            ...
            appBar:
                titledAppBar(context, title: context.l10n.legal_mentions_page),
            // url: state is NewPaymentMethodDisplayingUrl ? state.url : null,
            url:
                "https://booking.urban-driver.com/ordergo.html?cid=20131&tid=60"),
      ),
    );
  }
}
