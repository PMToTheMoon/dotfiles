...
import 'package:app_client/payment_methods/new_payment_method/new_payment_method.dart';
...
class NewPaymentMethodPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final appBar = titledAppBar(
      context,
      title: context.l10n.new_payment_method_page_title,
      onBack: () => Navigator.of(context).pop(
        NewPaymentMethodResult.canceled,
      ),
    );
