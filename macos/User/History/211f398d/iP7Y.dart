...
class NewPaymentMethodPage extends StatelessWidget {
  ...
  static Future<NewPaymentMethodResult> open(BuildContext context) => Navigator.of(context).push(MaterialPageRoute(builder: (c) => NewPaymentMethodPage(),),) as NewPaymentMethodResult;
