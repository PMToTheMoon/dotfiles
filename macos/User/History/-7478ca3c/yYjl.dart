    ...
    return BlocProvider<CandidateEditEducationBloc>(
      ...
      child:
        ...
        child: Column(children: [
          ...
          Row(
            children: [
              _SubmitButton(_controller, widget.education),
              const SpaceSmall.w(),
              OutlinedButton(
...
class _SubmitButton extends StatelessWidget {
  const _SubmitButton(this._controller, this.education);
      ...
      context.read<CandidateEditEducationBloc>().add(
            CandidateEditEducationUpdated(
              data: EducationUpdate(
                ...
                startDate: snapshot.startDate ?? education.startDate,
  ...
  Widget build(BuildContext context) {
    ...
    return SubmitButton(
      ...
      child: Text(context.l10n.edit_education_from_button),
    );
  }
}
