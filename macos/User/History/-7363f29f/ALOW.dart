...
class CandidateProfessionalExperiencesBlocConsumer extends StatelessWidget {
  ...
  final void Function(
      BuildContext context, CandidateProfessionalExperiencesReady)? onSuccess;
  final void Function(
  ...
  final Widget Function(
      BuildContext context, CandidateProfessionalExperiencesReady) success;
  final Widget Function(
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<CandidateProfessionalExperiencesBloc,
      ...
      listener: (context, state) => state.mapOrNull(
        ...
        ready: (s) => onSuccess?.call(context, s),
