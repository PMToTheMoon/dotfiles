...
import 'package:bonemeal_core/src/config/exceptions.dart';
...
class BonemealConfig {
  /// Returns a parsed [BuildConfig] file in [root], if one exists, otherwise a
  /// default config.
  ///
  /// [root] should the path to a directory which may contain a `bonemeal.yaml`.
