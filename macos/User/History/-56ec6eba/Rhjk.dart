...
class Fields extends DelegatingSet<Field> {
  ...
  Fields toNullable() => Fields(map((f) => f.toNullable()).toSet());
...
extension CodeComposerFieldExtension on Field {
  Field toNullable() {
    ...
    final nullableTypeBuilder = typeRef.toBuilder()..isNullable = true;
    final nullableType = nullableTypeBuilder.build();
    final newField = toBuilder()..type = nullableType;
