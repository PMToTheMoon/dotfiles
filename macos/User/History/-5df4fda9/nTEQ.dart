...
class UserAccountBloc extends Bloc<UserAccountEvent, UserAccountState> {
  ...
  Future<void> _onInformationEdited(
    ...
    print(event.update.firstName);
    // We use this in combination with event transformer restartable to
    // ensure this event will not be triggered more than once every [kDebounceDelay]
    await Future.wait([
      Future.delayed(_kDebounceDelay),
      (() async {
        try {
