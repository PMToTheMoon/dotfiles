...
import 'package:zanalys/authentication/signin/view/signin_page.dart';
    ...
    switch (routeName) {
      ...
      case routeSignIn:
        builder = (BuildContext context) =>
            SignInPage(args: settings.arguments as SignInScreenArgs?);
        break;
      case routeHome:
      ...
      case routeOTP:
        builder = (BuildContext context) => OTPPage(
              args: settings.arguments as OTPPageArgs,
            );
        break;
