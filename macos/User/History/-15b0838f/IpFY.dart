...
mixin RepositoryFetchableSource on RepositorySource {
  ...
  Parameter toParameter() => param(repository.symbol!.camelCase, repository);
  Expression callFetch({ValueResolver? values}) => fetch.call(
        owner: repository.symbol?.camelCase,
        values: values,
      );
}
