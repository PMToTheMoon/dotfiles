...
import 'package:bonemeal/src/utils/utils.dart';
import 'package:bonemeal/src/global.dart';
...
class ModelsGenerator extends Generator {
  ...
  Future<void> generate(BuildStep step) async {
    ...
    for (final entry in yaml.entries) {
      final asset = step.context
          .dartAsset('$contextPath/models/${entry.key.snakeCase}.dart');
      asset.body.addAll(
