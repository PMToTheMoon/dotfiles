...
import 'package:common/src/widgets/observation/observation_card/models/record_to_card/record_to_complement.dart';
...
extension RecordToObservationCard on Record {
  ...
  ObservationCardData toInitialObservationCardData({
    ...
    final date = dateFromEpochOrPlaceholder(
      lastModifiedDate ?? int.tryParse(creationDate ?? ''),
    );
