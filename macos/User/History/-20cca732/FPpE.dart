...
class _CandidateAddSkillsViewState extends State<_CandidateAddSkillsView> {
  ...
  void _submitSkills() {
    final skillListState = context.read<CandidateSkillListBloc>().state;
    final update = Set<String>.from(skillListState.skills)
      ..removeAll(skillListState.pendingDeletions)
      ..addAll(_controller.value);
    context
