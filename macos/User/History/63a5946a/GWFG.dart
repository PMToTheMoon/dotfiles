      ...
      child: Row(
        children: [
          ...
          Expanded(
            ...
            child: StatusBar(
              value: data.progress,
              color: data.status == Status.blue
                  ? context.theme.extension<BadgeColors>()!.blue
                  : context.theme.extension<BadgeColors>()!.green,
              backgroundColor: data.status == Status.blue
                  ? context.theme.extension<BadgeColors>()!.blueContainer
                  : context.theme.extension<BadgeColors>()!.greenContainer,
            ),
          ),
          const SpaceSmaller.w(),
          StatusPercent(data.progress),
