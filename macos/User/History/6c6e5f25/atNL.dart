...
abstract class OptionSelect<T> extends StatefulWidget {
  const OptionSelect({
    ...
    this.controller,
            ...
            "Controller and initialValue can't be set at the same time.");
  ...
  Widget builder(BuildContext context, OptionSelectController controller);
}

class OptionSelectState extends State<OptionSelect> {
  late final controller =
      widget.controller ?? OptionSelectController(widget.initialValue);
...
class HorizontalOptionSelect<T> extends OptionSelect<T> {
  ...
  @override
  Widget builder(OptionSelectState state) {
    return Table(
