...
import 'package:zanalys/data/model/user.dart';
import 'package:zanalys/data/model/user_sign_in_status.dart';
import 'package:zanalys/data/network/api/authentication_api.dart';
import 'package:zanalys/data/network/api/document_api.dart';
import 'package:zanalys/data/network/api/user_api.dart';
import 'package:zanalys/data/network/mappers/document_type_mapper.dart';
import 'package:zanalys/data/network/mappers/sign_in_mapper.dart';
import 'package:zanalys/data/network/network_service.dart';
import 'package:zanalys/data/network/request/update_push_token_body.dart';
...
class DioNetworkService implements NetworkService {
  ...
  Future<void> init() async {
    ...
    if (env.isDebugBuild) {
      _dio.interceptors.add(LogInterceptor(
          ...
          responseHeader: true,
          responseBody: true,
          logPrint: (Object object) => AppServices.logs
              .debug(tag: 'NetworkDio', message: (object.toString()))));
    }
  ...
  _logout() async {
    ...
    AppServices.navigation.toSignIn(forced: true);
  }
