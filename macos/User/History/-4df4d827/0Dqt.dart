...
class BuildContextImpl extends BuildContext {
  ...
  BuildContextImpl.child(
    ...
    if (newSourceRelativePath != null) if (path.equals(
        parent.source.append(newSourceRelativePath).path, parent.source.path)) {
      throw ArgumentError('ChildContext can\'t redirect to the same file');
    }
  }
