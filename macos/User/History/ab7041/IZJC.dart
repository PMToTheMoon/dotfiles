...
class AnimatedLoadedList<T> extends StatelessWidget {
  ...
  Widget _buildList(BuildContext context, bool loading) {
    final count = loading ? placeholderNumber : items.length;
    if (loading == false && items.isEmpty) return emptyBuilder(context);
    return ListView.separated(
