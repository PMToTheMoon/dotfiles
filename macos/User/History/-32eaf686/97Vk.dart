...
class ChipEditorFormFieldWidget extends FormPartWidget {
  @override
  Expression get widgetType => throw UnimplementedError();
}
...
class ChipEditorFormField extends FormField {
  ...
  @override
  FormFieldController get controller => throw UnimplementedError();

  @override
  FormPartWidget get widget => throw UnimplementedError();
}
