...
import 'package:tech_by_tech/candidate/candidate_home_page%20copy.dart';
...
class _AppRouterState extends State<AppRouter> {
  ...
  late final GoRouter _router = GoRouter(
    ...
    routes: [
      ...
      ShellRoute(
        // path: '/candidate',
        // Temporray workaround for go router prototype
        path: '/',
        // defaultRoute: 'home',
        ...
        routes: [
          // NestedStackRoute(path: 'home', builder: builder),
          NestedStackRoute(
            path: 'home',
