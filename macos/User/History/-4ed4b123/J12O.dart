...
import 'package:bonemeal_gen/src/utils/extract_code.dart';
...
Method extractMethodFromExecutableElement(
  ...
  extractFunctionOrMethodBodyString(source, node);
  return method.build();
}
...
Iterable<Parameter> _optionalParameters(ExecutableElement element) {
  return element.parameters
      .where(
...
MethodModifier? _methodModifier(ExecutableElement element) {
