...
import 'package:bonemeal_core/src/generate/expected_outputs.dart';
...
class AssetGraph {
  ...
  Set<AssetId> _addGeneratedOutputs(
      ...
      int phaseNumber,
      BuilderOptionsAssetNode generatorOptionsNode,
      List<BuildPhase> buildPhases,
      String rootPackage,
    ...
    for (var output in outputs) {
      ...
      if (contains(output)) {
        ...
        if (existing is GeneratedAssetNode) {
          throw DuplicateAssetNodeException(
              rootPackage,
              existing.id,
              (buildPhases[existing.phaseNumber] as InBuildPhase)
                  .generatorLabel,
              (buildPhases[phaseNumber] as InBuildPhase).generatorLabel);
        }
      ...
      var newNode = GeneratedAssetNode(output,
          ...
          wasOutput: false,
          isFailure: false,
          builderOptionsId: generatorOptionsNode.id,
          isHidden: isHidden);
      if (existing != null) {
