...
import 'package:bonemeal/src/asset/writers/directory_reader_writer.dart';
...
class IOEnvironment {
  ...
  void exportBuild() {
    // final writer = DirectoryAssetWriter(config.outputDir);
    for (final asset in _cache.writtenAssets) {
      final path = p.relative(asset.path, from: config.outputDir);
      print(path);
    }
  }
}
