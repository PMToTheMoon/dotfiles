...
class _PinCodePage extends StatelessWidget {
  ...
  _onCodeStateChanged(BuildContext context, CodeState state) async {
    if (state is CodeSendError) {
      showError(context, message: context.l10n.unable_to_send_code_error);
    }
      ...
      child: WillPopScope(
        ...
        child: Page(
          ...
          body: Column(
            ...
            children: [
              context.headline5(context.l10n.sign_in_code_check_title),
              const Space2.h(),
              Padding(
...
class _CodeLoadingIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (state is CodeSubmitting) {
      return const Padding(
        padding: Padding2.vertical(),
