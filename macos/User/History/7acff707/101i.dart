  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UserAccountBloc, UserAccountState>(
      buildWhen: (previous, current) =>
          current is UserAccountReady || current is UserAccountError,
      builder: (context, state) => state.when(
        ready: _UserAccountView.new,
        error: ErrorIndicator.new,
        loading: ButtonLoadingIndicator.new,
        initial: ButtonLoadingIndicator.new,
      ),
    );
  }
}
          ...
          child: Column(
            ...
            children: [
              ...
              TbtTextFormField(
                ...
                controller: _userAccountFormController.biography,
                minLines: 4,
                maxLines: 8,
              ),
            ],
            ...
            children: [
              ...
              Align(
                ...
                child: ElevatedButton(
                    onPressed: _onInformationChanged,
                    child: const Text(
                      'Submit',
                    )),
              ),
