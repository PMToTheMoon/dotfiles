...
abstract class Fragment extends MetaObject {}

/// An element witch handle concrete operation
abstract class FragmentElement<T extends Fragment> extends Element<T> {
  FragmentElement(super.metaObject);

  void writeFragment() {
    final file = metaObject.file;
  }
...
abstract class MultiChildFragment<T extends MultiChildMetaObject>
    extends Element<T> {
