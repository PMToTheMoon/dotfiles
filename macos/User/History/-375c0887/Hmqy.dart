...
class _NewProfessionalExperienceCardState
  ...
  ProfessionalExperienceFormController _controller =
    ...
    return BlocProvider<CandidateNewProfessionalExperienceBloc>(
      ...
      child: CandidateNewProfessionalExperienceBlocListener(
        onSuccess: (c, s) => setState(() {
          _controller = ProfessionalExperienceFormController();
        }),
...
class _SubmitButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final state = context.select(
      (CandidateNewProfessionalExperienceBloc bloc) => bloc.state,
    );
    final isLoading = state is CandidateNewProfessionalExperienceLoading;
    return SubmitButton(
      loading: isLoading,
