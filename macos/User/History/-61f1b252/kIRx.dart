...
mixin _$CandidateEducationsState {
  List<Education> get experiences => throw _privateConstructorUsedError;
...
class _$_CandidateEducationsState implements _CandidateEducationsState {
  const _$_CandidateEducationsState(
      {required final List<Education> experiences,
  ...
  final List<Education> _experiences;
  @override
  List<Education> get experiences {
  ...
  @override
  String toString() {
    return 'CandidateEducationsState(experiences: $experiences, pendingDeletions: $pendingDeletions, pendingUpdates: $pendingUpdates, isLoading: $isLoading, error: $error)';
  }
