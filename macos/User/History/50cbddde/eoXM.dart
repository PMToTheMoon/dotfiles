...
String _transformFunctionDeclarationToVar({
  ...
  final content = inline
      ? _extractFunctionBody(source, declaration)
      : _extractFullDeclaration(source, declaration);
  final varName = '\$${declaration.name}';
  return """
...
String _extractFunctionOrMethod({
  required String source,
  required FunctionDeclaration declaration,
}) {}
...
String _extractFunctionBody(String source, FunctionDeclaration declaration) {
