...
class ForgotPasswordBloc
  ...
  ForgotPasswordSuccess _toSuccess(e, ForgotPasswordRequestingReset s) =>
      const ForgotPasswordSuccess(sentTo: s.email);
  ForgotPasswordError _toError(e, s) => const ForgotPasswordError();
