...
class FetchBloc extends Bloc {
  ...
  final Fields fetchContextualData; // paginated list

  @override
  InvokeExpression initialState(FreezedMetaData states) {
    return states.types['initial']!.$class.invoke(values: MapValueResolver());
  }
    ...
    final body = [
      ...
      refer('emit').call([
        state('loading').invoke({
          fetchType.name: refer('state.${fetchType.name}'),
