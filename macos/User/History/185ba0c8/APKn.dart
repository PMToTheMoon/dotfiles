...
extension CallClassMethod on Class {
  InvokeExpression invoke({
    ...
    values = values ?? SelfReferResolver();
  ...
  InvokeExpression _constOf(
    ...
    return InvokeExpression.constOf(
      ...
      resolver.resolveRequiredParameters(c.requiredParameters).toList(),
      resolver.resolveOptionalParameters(c.optionalParameters),
    );
  }

  InvokeExpression _newOf(Constructor c, ValueResolver resolver) {
