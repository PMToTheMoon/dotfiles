...
class _UploadButton extends StatelessWidget {
  ...
  Future<void> _onUploadDocumentPressed(BuildContext context, UploadDocumentBloc bloc,) async {
  ...
  void _pickImage(BuildContext context, ImageSource source, UploadDocumentBloc bloc,) async {
    final pickedFile = await ImagePicker().pickImage(source: source);
    if (pickedFile != null) {
      bloc.documentSelected(pickedFile.path);
    }
