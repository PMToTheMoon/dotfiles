...
class UnfoldableListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return frameBuilder?.call(context, controller, child) ?? child;
  }
}

class UnfoldableListCard extends UnfoldableListItem {
  UnfoldableListCard({
    super.key,
    required super.fold,
    required super.unfold,
  }) : super(
          frameBuilder: (context, controller, child) => TbtHoverCard(
            onTap: () {
