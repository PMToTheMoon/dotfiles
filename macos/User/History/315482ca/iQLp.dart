...
class TripDetailsBloc extends StateMachine<TripDetailsEvent, TripDetailsState> {
  TripDetailsBloc({
    ...
    // on<TripDetailsEvent>((event, emit) async {
    //   await state.mapOrNull(
    //     initial: (_) => event.whenOrNull(
    //       tripCancellationRequested: () => _onTripCancellationRequested(emit),
    //     ),
    //     cancellationInProgress: (_) {},
    //     cancellationError: (_) {},
    //     cancellationSuccess: (_) {},
    //   );
    // });
  }
