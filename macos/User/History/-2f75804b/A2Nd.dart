...
class BuildRunner {
  static Future<BuildRunner> create(
    ...
    final assetWriterSpy = RunnerAssetWriterSpy(environment.writer);
  ...
  final AssetWriterSpy assetWriterSpy;
