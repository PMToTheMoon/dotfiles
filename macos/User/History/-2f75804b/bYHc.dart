...
class BuildRunner {
  ...
  Future<BuildResult> run() async {
    ...
    final buildReader = BuildCacheReader(environment.reader, assetGraph);
    final buildWriter = BuildCacheWriter(environment.writer, assetGraph);
    final result = await _runGenerators(assetGraph, phases, read);
