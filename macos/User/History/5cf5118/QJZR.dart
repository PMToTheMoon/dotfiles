...
class _RelocatedAssetWriter implements RunnerAssetWriter {
  ...
  _RelocatedAssetWriter(
      this._delegate, this._assetGraph, this._rootPackage, this._root);
  ...
  @override
  Future delete(AssetId id) => _delegate.delete(_location(
        id,
        _rootPackage,
      ));
}

AssetId _location(AssetId id, String rootPackage, String root) {
  if (id.path.startsWith(root)) {
    return id;
  }
  return AssetId(
    rootPackage,
    '$root/${id.package}/${id.path}',
  );
}
