...
class RelocatedAssetWriter implements RunnerAssetWriter {
  final AssetGraph _assetGraph;
  final RunnerAssetWriter _delegate;
  final String _rootPackage;
  final String _root;

  RelocatedAssetWriter(
      this._delegate, this._assetGraph, this._rootPackage, this._root);

  @override
  Future writeAsBytes(AssetId id, List<int> content) =>
      _delegate.writeAsBytes(_location(id, _rootPackage, _root), content);

  @override
  Future writeAsString(AssetId id, String content,
          {Encoding encoding = utf8}) =>
      _delegate.writeAsString(_location(id, _rootPackage, _root), content,
          encoding: encoding);
