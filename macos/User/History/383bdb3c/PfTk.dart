                  ...
                  children: [
                    ...
                    TextButton(
                      ...
                      style: ButtonStyle(
                        ...
                        textStyle: tbtFeedback(
                          idle: TextStyle(color: context.tbtColors.text),
                          pressed: TextStyle(color: context.tbtColors.error),
                          emphasized: TextStyle(color: context.tbtColors.error),
                        ),
                      ),
                      child: Row(
                        children: [
