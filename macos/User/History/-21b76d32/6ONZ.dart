...
class StateDefinitionBuilder<Event, State, DefinedState extends State> {
  ...
  /// Register [transition] function as [DefinedState]'s event handler
  /// for [DefinedEvent]
  ///
  /// If [transition] return a [State], state machine will transition to it
  /// and stop any further event handlers evaluation.
  /// If [transition] return null, state machine will transition to it
  /// and stop any further event handlers evaluation.
  ///
  /// [onExitCallback] will be called when the state machine exit [DefinedState].
  /// It will not be called if next state is one of [DefinedState]'s nested states.
