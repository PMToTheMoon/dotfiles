...
void _printFormatted(
  ...
  if (color != null) {
    Console.setTextColor(color, bright: bright);
  } else {
    Console.setTextColor(7, bright: bright);
  }
