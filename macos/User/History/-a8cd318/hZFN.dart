...
abstract class CandidateService extends ChopperService {
  ...
  @Put(path: '/{candidateId}/pro-experiences/{experienceId}')
  Future<Response<void>> updateProfessionalExperience(
    @Path() String candidateId,
    @Path() String experienceId,
    @Body() ProfessionalExperienceUpdate update,
  );
  ...
  @Put(path: '/{candidateId}/educations/{educationId}')
  Future<Response<void>> updateEducation(
    @Path() String candidateId,
    @Path() String educationId,
    @Body() EducationUpdate update,
  );
