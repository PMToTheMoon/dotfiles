...
Ne pas chercher à faire du code générique. La refacto est gratuite lorsuqu'on utilise un generateur de code. Si une abstraction est néscessaire à un moment T, la modification sera simplement appliqué au générateur. Ne pas chercher à anticiper les abstraction évite bien souvent de faire des abstractions sous-optimales.
- Faire le code spécifique à la main.
Le générateur ne peut pas tout faire. Certains problèmes doivent être résolus à la main.
