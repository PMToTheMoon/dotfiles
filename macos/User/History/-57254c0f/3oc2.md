...
Les fichiers d'entré sont le plus souvent écrit en yaml, mais il n'y a aucune limite au format du fichier. Le but de ces inputs sont de représenter au mieux un problème donné.