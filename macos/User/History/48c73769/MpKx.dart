...
class HookBuilder extends GeneratorForAnnotation<ToHook> {
  ...
  Future<String> generateForAnnotatedElement(
    ...
    final hookInstances = hookNames.map((e) => refer(e).newInstance([]).code);
    final hookList =
        literalList(hookNames.map((e) => refer(e).newInstance([]))).accept();
    final allHooksVar = "final ${element.displayName.pascalCase}Hooks = [}];";
