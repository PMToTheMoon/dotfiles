...
import 'package:zanalys/authentication/authentification.dart';
import 'package:zanalys/data/model/user_sign_in_status.dart';
import 'package:zanalys/authentication/signin/bloc/signin_event.dart';
...
class SignInBloc extends Bloc<SignInEvent, SignInState> {
  ...
  void _onSignInSubmitted(
    ...
    if (state.status.isValidated) {
      ...
      try {
        UserSignInStatus status = await AppServices.network
            .signIn(identifier: identifier.value, password: password.value);
        if (status == UserSignInStatus.authenticated) {
