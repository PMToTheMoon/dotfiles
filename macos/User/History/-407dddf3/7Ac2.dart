...
import 'record_reason.dart';

import 'doctor_service_request.dart';

export 'doctor_service_request.dart';
...
class NewRecord with _$NewRecord {
  ...
  const factory NewRecord({
    ...
    @JsonKey(name: 'prestataires', toJson: _doctorServiceRequestToJson)
...
List<Map<String, dynamic>> _doctorServiceRequestToJson(
  List<DoctorServiceRequest> l,
) =>
    l.map((r) => r.toJson()).toList();
