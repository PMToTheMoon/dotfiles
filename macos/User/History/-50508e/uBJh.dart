    ...
    return MultiBlocProvider(
      ...
      child: DecoratedBox(
        ...
        child: Column(
          ...
          children: [
            Visibility(
              visible: currentTab == ZanalysBottomNavigationTab.home,
              child: Expanded(
                child: _pages[ZanalysBottomNavigationTab.home]!,
              ),
            ),
            Visibility(
              visible: currentTab == ZanalysBottomNavigationTab.patients,
              child: Expanded(
                child: _pages[ZanalysBottomNavigationTab.patients]!,
              ),
            ),
