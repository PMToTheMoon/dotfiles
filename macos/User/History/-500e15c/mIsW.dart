...
class ObservationsBloc extends Bloc<ObservationsEvent, ObservationsState> {
  ObservationsBloc() : super(const ObservationsIdle()) {
    ...
    on<ObservationsNewObservationShared>(_onNewObservationShared);
  }
  ...
  Future<void> _onCompleteRecordButtonPressed(
    ...
    emit(const ObservationsState.displayingForm());
  }

  Future<void> _onNewObservationShared(
    ObservationsNewObservationShared event,
    Emitter emit,
  ) async {
