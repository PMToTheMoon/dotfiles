...
class ZanalysPrivateApiClient {
  ...
  Future<void> updateGeneralRecord(GeneralRecordUpdate request) async {
    ...
    final formData = FormData.fromMap({
      ...
      "jsonData": jsonEncode({  "dossiersEnfants": [],
  "type": "MULTI",
  ...
  "paymentCode": "I5jOgUVceEBIwrhfNQnm0p+zv4aQgz+/oHBPMLRVDd8FlaZmZi7pycBpmgvRh1X+jWK10fesGPn7vd7+n0jxLaCjHHK4Dp0WwgNA7pjTf+U=",
