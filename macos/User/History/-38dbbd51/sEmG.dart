...
import 'package:bonemeal_core/src/generate/build_directory.dart';
import 'package:bonemeal_core/src/generate/build_result.dart';
import 'package:bonemeal_core/src/generate/finalized_assets_view.dart';
...
abstract class BuildEnvironment {
  ...
  ///
  /// If this environment is non-interactive (such as when running in a test)
