...
class FlightSelectionState with _$FlightSelectionState {
  ...
  const factory FlightSelectionState.submittingFlightNumber() = _FlightSelectionState;
  const factory FlightSelectionState.flightSelectionSuccess() = _FlightSelectionState;
  const factory FlightSelectionState.flightSelectionError() = _FlightSelectionState;
}